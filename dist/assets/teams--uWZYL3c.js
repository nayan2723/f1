import"./f1data-CYHUHGUy.js";document.getElementById("navbar-root").innerHTML=renderNavbar("teams.html");document.getElementById("footer-root").innerHTML=renderFooter();document.getElementById("team-grid").innerHTML=F1Data.teams.map((a,s)=>{const e=F1Data.constructorStats[a.id],i=F1Data.getDriversByTeam(a.id).map(t=>t.name).join(" & "),r=[{label:"Points",value:e.pts,max:800},{label:"Wins",value:e.wins,max:24},{label:"Podiums",value:e.podiums,max:48},{label:"Poles",value:e.poles,max:24},{label:"1–2 Finishes",value:e.oneTwo,max:24}].map(t=>`
